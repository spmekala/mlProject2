 ...
 * @version 1.0
 */
public class NewCoderSurveyRHCOptimal {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < oaResultsTrain.size(); i++) {
            ...
            double first = Math.min(oaResultsTrain.get(i).get(0), oaResultsTrain.get(i).get(1));
            double second = Math.min(oaResultsTest.get(i).get(0), oaResultsTest.get(i).get(1));
