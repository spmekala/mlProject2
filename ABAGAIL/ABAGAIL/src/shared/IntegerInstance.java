 ...
 * @version 1.0
 */
public class IntegerInstance implements Serializable, Copyable {
     ...
     */
    public IntegerInstance(Vector data, Instance label, double weight) {
        this.data = data;
        this.label = label;
        this.weight = weight;
    }
     ...
     * @param label the label
     */
    public IntegerInstance(Vector data, Instance label) {
        this.data = data;
        this.label = label;
        this.weight = 1.0;
    }
     ...
     */
    public IntegerInstance(Vector v) {
        data = v;
        weight = 1.0;
    }
     ...
     * @param ds the data
     */
    public IntegerInstance(double[] ds) {
     ...
     * @param val the value
     */
    public IntegerInstance(double val) {
     ...
     * @param o the output
     */
    public IntegerInstance(int i, int o) {
        this(i);
     ...
     * @param i the output
     */
    public IntegerInstance(double[] ds, int i) {
        this(ds);
     ...
     * @param b the label
     */
    public IntegerInstance(double[] ds, boolean b) {
        this(ds);
     ...
     * @param val the value
     */
    public IntegerInstance(boolean val) {
        this(val ? 1 : 0);
    }
